...
namespace WebApi.Minimized.Core.Entities
{
    public partial class Newsletter
    {
        ...
        public string NewsletterSkype { get; set; }
        public string NewsletterViber { get; set; }
        public string NewsletterWhatsUp { get; set; }
        public string NewsletterVk { get; set; }
        public decimal? NewsletterPrice { get; set; }
        public DateTime? NewsletterNotify { get; set; }
        public DateTime? NewsletterUnsubscribed { get; set; }
    }
}
